package com.example.wika.historyid.adapters;
...
import com.example.wika.historyid.Constant;
import com.example.wika.historyid.R;
import com.example.wika.historyid.Settings;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> {
    ...
    public class ListViewHolder extends ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView) {
            ...
            contentText = itemView.findViewById(R.id.text_content); float textSize = settings.getTextSize();
